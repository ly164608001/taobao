...
var version   = '2.0';  //版本号
var ajaxUrl   = '/test/ajax';  //所有ajax操作指向页面
var zoomlevel = 1;
var TEMP      = {};
var HROS      = {};
	...
	return {
		...
		*/
		init : function(){
			...
			*/
			swfobject.embedSWF('/hos/js/zoom.swf?onchange=HROS.zoom.check', 'zoombox', '10', '10', '6.0.0', 'expressInstall.swf', '', {allowScriptAccess : 'always', wmode : 'transparent', scale : 'noScale'}, {id : 'accessory_zoom', name : 'zoom_detect'});
		},
		/*
		**  为什么会有个参数o？其实我也不知道
