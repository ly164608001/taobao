...
<body>
	...
	<form id="addform" action="${basePath}/admin/activity/seehouse/addsave.htm"
		method="post">
		...
		<table cellpadding="5">
			...
			<tr><td>活动地址:</td>
				<td><input name="address" class="easyui-validatebox textbox"
					data-options="missingMessage:'请输入活动地址',required:true" value=""></td>
			</tr>
					
			<tr><td>限制人数:</td><td><input name="personnum" class="textbox"
					data-options="missingMessage:'请输入限制人数,默认不限制',required:true" value="">个 （不填默认为不限制）</td>
			</tr>
			
			<tr><td>房团优惠:</td><td></td></tr>
			
			<tr><td></td><td ><textarea name="activitycontent" rows="7" cols="50"></textarea></td>
			</tr>
