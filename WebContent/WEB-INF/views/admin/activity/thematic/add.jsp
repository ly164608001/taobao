...
<body>
	...
	<form id="addform" action="${basePath}/admin/activity/thematic/addsave.htm"
		method="post">
		...
		<table cellpadding="5">
			...
			<tr><td>限制人数:</td><td><input name="personnum" class="textbox"
					data-options="missingMessage:'请输入限制人数,默认不限制',required:true" value=""></td>
			</tr>
			
			<tr><td>活动内容:</td><td></td></tr>
			
			<tr><td colspan="2"><textarea name="activitycontent" rows="7" cols="50"></textarea></td>
			</tr>
