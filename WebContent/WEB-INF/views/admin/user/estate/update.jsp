...
<script type="text/javascript" src="${basePath}static/js/easyui.validexts.js"></script>

</head>
<body>

	<form id="updateform" action="${basePath}admin/user/estate/updatesave.htm" method="post">
