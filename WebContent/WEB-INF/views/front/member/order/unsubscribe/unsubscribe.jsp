        		...
        		<div class="reverse-body mt10">
        			...
        			<div class="reverse-order">
        				...
        				<div class="reverse-order-total clearfix mt15">
        					<span class="total-money-complete">订金金额：&nbsp;<span class="red">30,000</span>&nbsp;元</span>        		
        				</div>
        			</div>
       				...
       				<form id="submitForm">
			            ...
			            <div class="comment-body mt20">
			                <div class="row clearfix">
			                  ...
			                  <div class="comment-body-ipt">
			                    <select name="reasonid">
			                      <option value="1">不符合心意</option>
			                      <option value="2">房子太贵</option>
			                      <option value="3">距离太远</option>
			                    </select>
			                  </div>
			                </div>
			                ...
			                <div class="row mt10 clearfix">
			                  ...
			                  <div class="comment-body-ipt">
			                    <input type="text" name="money" value="" onkeyup='this.value=this.value.replace(/\D/gi,"")'>
			                 ...
			                 <div class="row mt10 clearfix">
			                  ...
			                  <div class="comment-body-ipt fl">
			                    <textarea class="offerPayTxt" name="description" id="description"></textarea>
			                  </div>
			                </div>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$('.btn-submit').click(function(){
			submitUnsub('${basePath}/front/member/order/submitUnsubscribe.htm');
		});
