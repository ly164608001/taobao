...
<title>个人中心-用户管理-认证-确认身份信息-iframe</title>
        ...
        <div class="PersonalCenter-main-r">
            ...
            <div class="CaptureroomRecord">
                ...
                <div class="personStep-img">
                    <img src="${basePath}/static/css/front/images/person-step03.png">
                </div>
                        ...
                        <div class="PersonalData-base clearfix">
                            ...
                            <div class="btnStep mt100">
                                    <a href="javascript:void(0)"
										onclick="parent.changeMenu('${basePath}/au/writeBankCard.htm')">上一步</a>
                                    <a href="javascript:void(0)"
										onclick="parent.changeMenu('${basePath}/au/waitAudit.htm')">确认</a>
                                </div> 
                        </div>
                    </div>
