		...
		<div class="header">
			<div class="panel panel-default panel-shenHead">
				<div class="panel-body">
					<h5>
						您当前的任务审核模式
						<input class="btn radius btn-secondary btn-change" type="button" value="修改任务审核模式"></h5>
					<p>
						<span>
							1、审核已付款：
							<span class="orange">商家自审</span>
						</span>
						<span>
							2、审核确认收货好评：
							<span class="orange">商家自审</span>
		...
		<section class="mt20">
			<div class="panel panel-default panel-tips mt20">
				...
				<div class="panel-body">
					<p>
						1、确认要发布任务的产品
						<span class="orange">已关闭淘宝客</span>
						的推广，以免部分买家利用淘宝客获得额外您的推广佣金；
					</p>
					<p>
						2、买家如没按商家要求做任务，商家可以投诉，
						<span class="orange">平台只受理未完成任务的投诉</span>
						，任务完成不再受理；
					</p>
					<div class="showHide">
						<p>
							3、快递
							<span class="orange">物流出现卡住或没有物流信息</span>
							的情况，淘宝上发货
						...
						<p>
							4、在任务【
							<span class="orange">接手方已付款，等待商家审核</span>
							】的商家审核步骤，请商家严格审查
							<span class="orange">买家付款信息(订单号、买家旺旺号)</span>
							等信息 ，如出现不一致，请马上提起申诉，否则后续出现相关问题后果自负。比如：❶、出现接单旺旺号与店铺实际下单旺旺号不一致，但您也给审核通过了，导致后面您真实发货，后果自负；❷、出现买家在旺旺刷平台回填的订单号与店铺实际下单的订单号不一致，但您也给审核通过了，导致后面您真实发货，后果自负；
						</p>
						<p>
							5、在任务【
							<span class="orange">确认收货好评，完成任务</span>
							】的商家审核步骤，默认审核操作时间
							<span class="orange">24小时</span>
							，请商家严格审查
							<span class="orange">买家是否确认收货和好评</span>
						...
						<p>
							...
							<span class="orange">24小时</span>
							内未审核，如果
							<span class="orange">再超过24小时</span>
							还未审核，即在
							<span class="blue">48小时未审核</span>
							，系统将自动返款(本金和佣金)给买家，请商家及时审核，出现相关问题后果自负。任务有超时会补偿旺点给买家（
							<span class="blue">每超出12小时补偿2个旺点</span>
							）；
						</p>
						<p>
							7、
							<span class="blue">1个旺点=0.68元</span>
							；
						</p>

						<p>
							8、【
							<span class="blue">重要说明</span>
							】 若商家的账户余额不足（
							<span class="orange">
								余额
								< 0元</span>
			...
			<div class="progressImg mt20">
				<img src="${basePath}static/css/front/images/tasklc2.png"></div>
			<div class="workDoing mt20">
				<div id="tab_demo" class="HuiTab">
					<div class="tabBar cl">
						<span class="clearfix tip-numberWrap"> <em class="f-l">要你操作的任务</em> <em class="tips-number f-l">20</em>
						</span>
						<span>
							<em class="f-l">进行中的任务</em>
							<em class="tips-number f-l">20</em>
						</span>
						<span>
							<em class="f-l">暂停中的任务</em>
							<em class="tips-number f-l">20</em>
						</span>
						<span>
							<em class="f-l">已完成的任务</em>
							<em class="tips-number f-l">20</em>
						</span>
						<span>
							<em class="f-l">全部任务</em>
							<em class="tips-number f-l">20</em>
						</span>
					</div>
					<div class="tabCon">
						<div class="search-tab mt20 search-tab-other">
							<ul>
								<li class="tab02">
									...
									<input type="text" placeholder="请输入单品价格" class="input-text radius size-M"></li>
								<li class="tab02">
									<span class="tab-title">发布时间：</span>
									<span class="timeBet"></span>
									<span class="tab-title">店铺名称：</span>
								...
								<thead>
									...
									<tr>
										<th>
											<input type="checkbox" name=""></th>
										<th colspan="6">
											<span class="mr10">发布时间：2015-02-05 22:51:56</span>
									...
									<tr>
										...
										<td>
											...
											<span>
												...
												<span class="label label-warning radius">浏览</span>
												<br>
												<span class="pt5 order">
													淘宝订单号：
													<em class="red">1639040737871287</em>
												</span>
												<span>
													<a href="#" class="btn btn-link btnBady">查看宝贝截图</a>
												</span>
											</span>
										</td>
										<td>
											<span class="red">8.04元</span>
											<span>11.82个旺点</span>
										</td>
										<td>
											<span>申诉中</span>
											<span>
												<a href="#" class="btn btn-link">我要撤销申诉</a>
											</span>
										</td>
										<td>
											<span>
												<a href="#" class="btn btn btn-secondary radius btn-sure">我要审核</a>
											</span>
											<span>
												<a href="#" class="btn btn-link btn-answer">查看申诉</a>
											</span>
											<span>
												<a href="#" class="btn btn-link">查看任务详情</a>
											</span>
										</td>
									</tr>
									<tr>
										<td colspan="5">
											<span>
												接手方：
												<img src="${basePath}static/css/front/images/vip0.jpg">
												(IP:
												<em>106.3.45.233</em>
												) 接手时间：
												<em>2016/6/24 18:03:59</em>
												付款时间：
												<em>2016/6/24 19:07:50</em>
											</span>
										</td>
										<td>
											<span>
												<i class="wangwang"></i>
												采用买号
												<em class="blue">独家秀秀</em>
											</span>
										</td>
										<td>
											<span>
												<a href="#" class="btn btn-link">查看淘宝地址</a>
											</span>
										</td>
									</tr>
								</tbody>
						...
						<div class="  mt10 text-c">
							<a href="#" class="btn btn-secondary radius">
								<i></i>
								刷新任务
							</a>
						</div>
