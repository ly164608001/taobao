...
<body>
	...
	<form action="${basePath}front/seller/main.htm" id="form" method="post"> 
...
<header class="navbar-wrapper">
	<div class="navbar navbar-black navbar-orange navbar-fixed-top">
		...
		<div class="container cl">
			<div class="logo">
				<a href="${basePath}front/seller/index.htm">
			...
			<nav class="nav navbar-nav nav-collapse" role="navigation" id="Hui-navbar">
				<ul class="cl">
					<li class="current">
						<a href="${basePath}front/seller/index.htm">首页</a>
					</li>
					<li>
						<a href="${basePath}front/seller/task/taskHall.htm">任务大厅</a>
					</li>
					<li >
						<a href="javascript:void(0);" onclick="changeMenu('front/seller/task/taskList.htm');">任务管理</a>
					</li>
			</ul>
		</nav>
