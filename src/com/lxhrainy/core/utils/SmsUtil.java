...
public class SmsUtil {
	...
	public static String userid = "1040";		//用户id
	public static String account = "FJWTWL";		//帐号	
	public static String password = "honglin123456";  	//密码
	public static String url = "http://121.199.50.122:8888/sms.aspx";	//短信地址

/*	public static void main(String[] args) {
		send("17750310332", "hi，您好，测试短信【微太网】");
	}*/
	
	/**
	 * @Title: sendByTemplate 
	 * @Description: 根据模板发送短信
	 * @param templateid
	 * @param mobile
	 * @param strs
	 ...
	 * @throws
	 */
	public static boolean sendByTemplate(int templateid, String mobile, String[] items, String templateContent) {
		...
		if(items!=null && items.length > 0)
		{
			...
			{
				templateContent = templateContent.replace("{"+i+"}", items[i]);
			}
		}
		return send(mobile,templateContent);
	}
	...
	public static boolean send(String mobile,String content)
	{
		...
		try{
			...
			if(element!=null)
			{
				if(element.getTextTrim().toLowerCase().equals("success"))
				{
					return true;
				}
			}
