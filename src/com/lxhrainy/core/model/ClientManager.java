...
import com.lxhrainy.core.utils.EhcacheUtil;
import com.lxhrainy.core.utils.StringUtil;

/**
 * @ClassName: ClientManager 
 * @Description: 对在线用户的管理
 * @author lxhrainy 
 * @date 2016年5月19日 下午2:10:41
 */
public class ClientManager {
	...
	public Client getClient(String sessionId){
		if(!StringUtil.isEmpty(sessionId)&&ContextHolderUtils.getSession().getAttribute(sessionId)!=null){
